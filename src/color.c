...
static const DefaultColorNode DEFAULT_COLORS[] = {
   ...
   { COLOR_MENU_SEPARATOR_FG,       THEME_TEXT        },
   { COLOR_MENU_SEPARATOR_BG,       THEME_INACTIVE2   },
   { COLOR_MENU_SEPARATOR_OUTLINE,  THEME_INACTIVE2   },
...
static struct {
   ...
   { COLOR_TASKLIST_ACTIVE_BG1,     COLOR_TASKLIST_ACTIVE_UP,        COLOR_TASKLIST_ACTIVE_DOWN    },
   { COLOR_TASKLIST_MINIMIZED_BG1,  COLOR_TASKLIST_MINIMIZED_UP,     COLOR_TASKLIST_MINIMIZED_DOWN },
   { COLOR_TRAYBUTTON_BG1,          COLOR_TRAYBUTTON_UP,             COLOR_TRAYBUTTON_DOWN         },
   { COLOR_TRAYBUTTON_ACTIVE_BG1,   COLOR_TRAYBUTTON_ACTIVE_UP,      COLOR_TRAYBUTTON_ACTIVE_DOWN  },
